...
//         dd($request);
    ...
    public function update(Request $request, $id){
        try {
            ...
            $record->suledo_base                = $request->input('suledo_base', $record->suledo_base);
            ...
            $record->suledo_ex_noche            = $request->input('suledo_ex_noche', $record->suledo_ex_noche);
            $record->total_ex                   = $request->input('total_ex', $record->total_ex);
            $record->bon_legal                   = $request->input('bon_legal', $record->bon_legal);
            ...
            $record->incentivo_pn1              = $request->input('incentivo_pn1', $record->incentivo_pn1);
            $record->incentivo_as1              = $request->input('incentivo_as1', $record->incentivo_as1);
            ...
            if ($record->save()) {
                $this->status_code  = 200;
                $this->result       = true;
                $this->message      = 'Planilla actualizada correctamente';
                $this->records      = $record;
            } else {
