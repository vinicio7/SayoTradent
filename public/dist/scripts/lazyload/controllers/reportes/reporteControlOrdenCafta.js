;(function()
{
    ...
    angular.module('app.reportesControlOrdenCafta', ['app.service.reportes'])

        .controller('ReportesControlOrdenCaftaController', ['$scope', '$filter', '$http', '$modal', '$interval', 'ReportesService', function($scope, $filter, $http, $modal, $timeout, ReportesService)  {
