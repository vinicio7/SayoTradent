;(function()
{
    ...
    angular.module('app.proveedores', ['app.service.proveedores'])
        ...
        .controller('ProveedoresController', ['$scope', '$filter', '$http', '$modal', '$interval', 'ProveedoresService', function($scope, $filter, $http, $modal, $timeout, ProveedoresService)  {
            ...
            $scope.modalCreateOpen = function() {
                ...
                $scope.action = 'new'; 
                modal = $modal.open({
                    templateUrl: 'views/administracion/modal_proveedores.html',
                    scope: $scope,
                    size: 'lg', 
                    resolve: function() {},
                    windowClass: 'default'
